       ...
       <div>
            <Navbar bg='dark' variant="dark">
                ...
                <Navbar.Collapse className="justify-content-end">
                    ...
                    <Nav>
                        <Nav.Link href="#Welcome"><Link to={`/admin/addtheatre`}><Button type="submit">Add Theatres</Button></Link></Nav.Link>
                        <Nav.Link eventKey={2} >
                            <Link to={`/admin/addmovie`}><Button type="submit">Add Movies</Button></Link>
                     </Nav.Link>
                    < Nav.Link eventKey={3} >
                            <Link to={`/admin/movieslist`}><Button type="submit">View Movies</Button></Link>
                     </Nav.Link>
                     < Nav.Link eventKey={4} >
                            <Link to={`/admin/theatreslist`}><Button type="submit">View Theatres</Button></Link>
                     </Nav.Link>
                     < Nav.Link eventKey={5} >
            ...
            <Carousel>
                ...
                <Carousel.Item interval={500}>
                    <img
                        className="d-block w-100"
                        src="https://images.unsplash.com/photo-1494587351196-bbf5f29cff42?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1502&q=80"
                        alt="Second slide"
                    />
                    <Carousel.Caption>
